...
urlpatterns = [
    ...
    path('manifest.json', ManifestJSON, name='manifestJSON'),
    path('serviceworker.js', ServiceWorkerJS, name='serviceWorkerJS'),
    path('offline/', OfflinePage, name='offlinePage'),
    path('wishlist/', WishlistDetail, name='wishlistDetail'),
    path('wishlist/toggle/<int:productId>/', WishlistToggle, name='wishlistToggle'),
